  ...
  if (category) {
    aiModels[category].push({
      ...
      sample_spec: {
        ...
        input_cost_per_token: model.input_cost_per_token !== undefined ? model.input_cost_per_token : null,
        output_cost_per_token: model.output_cost_per_token !== undefined ? model.output_cost_per_token : null,
